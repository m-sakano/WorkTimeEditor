      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="masthead clearfix">
            <div class="inner">
              <h3 class="masthead-brand"><?php echo BRAND; ?> <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></h3>
            </div>
          </div>

          <div class="inner cover">
            <h1 class="cover-heading">View and edit your work time.</h1>
            <p class="lead">
            	出社/退社の時刻を確認、修正できます。
            	アカウントでログインしてご利用ください。
            <p class="lead">
